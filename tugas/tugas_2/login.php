...
<body class="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="w-full max-w-md glass-card p-8 md:p-10 rounded-3xl shadow-2xl relative z-10">
       ...
       <a href="index.php" class="mt-6 flex items-center justify-center gap-2 bg-[#E5E5E5] text-black font-bold px-6 py-3 rounded-xl transition duration-300 hover:bg-stone-300">
    <!-- Ikon Panah -->
